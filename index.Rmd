...
Each state in the map of the United States is shaded based on the proportion of fatal accidents in which impaired driving played a role to total fatal accidents. The relationship between total fatal accidents and impaired fatal accidents indirectly shows the prevalence of impaired driving in across the United States. It also represents how a large number of the deaths we see as a result of road traffic accidents can be attributed to alcohol or other substances in some way.
